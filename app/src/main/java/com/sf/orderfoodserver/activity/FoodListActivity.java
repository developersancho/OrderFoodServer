            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (newFood != null) {
                    ...
                    Snackbar.make(findViewById(android.R.id.content),
                            "New category " + newFood.getName() + " added", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
